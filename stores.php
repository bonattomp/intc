...
<?php 
 ...
 $array = array("ALBERTA ","International Clothiers","We carry boys wear size 7-16","9703-19th Avenue N.W.","Edmonton"," AB","T6N 1N5","780-409-4232"); storeouput($array); 
...
$array = array("BRITISH COLUMBIA ","International Clothiers","We carry boys wear size 7-16","Central City","2153 Surrey Pl. Mall #382","Surrey"," BC","V3T 2W1","604-581-2505"); storeouput_city($array);
$array = array("BRITISH COLUMBIA ","International Clothiers","We carry boys wear size 7-16","Guildford Town Centre","2577 104Th Ave. Unit 48","Surrey"," BC","V3R 7C1","604-588-0401"); storeouput($array);
...
$array = array("NEW BRUNSWICK","International Clothiers","We carry boys wear size 7-16","Lancaster Mall","621 Fairville Blvd, Unit # B2","St. John"," NB","E2M 4X5","506-653-9806"); storeouput_city($array);
...
<?php 
$array = array("NEWFOUNDLAND","International Clothiers","Men's","Avalon Malll","48 Kenmount Road","St.John's"," NF","A1B 1W3","709-739-6737"); storeouput_city($array);
?>
<hr width="100%" size="1" noshade />
...
$array = array("NOVA SCOTIA","International Clothiers","We carry boys wear size 7-16","Dartmouth Crossing","93 Hector Gate","Halifax"," NS","B3B 0B8","902-468-7422"); storeouput_city($array);
...
$array = array("ONTARIO","International Clothiers","We carry boys wear size 7-16","Georgian Mall","509 Bayfield Street","Barrie"," ON","L4M 4Z8","705-728-8728"); storeouput_city($array);
...
$array = array("ONTARIO","International Clothiers","We carry boys wear size 7-16","Jackson Squarel","2 King Street West","Hamilton"," ON","L8P 1A1",""); storeouput($array);
...
$array = array("ONTARIO","Stockhomme","We carry boys wear size 7-16","White Oaks Mall","1105 Wellington Road","London"," ON","N6E 1V4","519-649-5200"); storeouput_city($array);
...
$array = array("ONTARIO","International Clothiers","","Orfus Road","111 Orfus Roade","North York"," ON","M6A 1M4","416-785-1771"); storeouput($array);
...
$array = array("ONTARIO","International Clothiers","Men's/Boy's","Oshawa Shopping Centre","419 King Street West ","Oshawa"," ON","L1J 2K5","905-723-5842"); storeouput_city($array); 
$array = array("ONTARIO","International Clothiers","Men's/Boy's","Oshawa South","580 Laval Drive","Oshawa"," ON","L1J 6L8","905-728-5842"); storeouput($array); 

$array = array("ONTARIO","International Clothiers","Men's/Boy's","Pembroke Mall","100 Pembroke Street East","Pembroke"," ON","K8A 6Y7","855-429-1683"); storeouput_city($array);
...
$array = array("ONTARIO","International Clothiers","","Scarborough Town Centre","300 Borough Drive","Scarborough"," ON","M1P 4P5","416-296-1632");storeouput($array); 
...
$array = array("ONTARIO","International Clothiers","Men's/Boy's","New Sudbury Centre","1349 Lasalle Blvd.","Sudbury"," ON","P3A 1Z2","705-521-1074"); storeouput_city($array); 

$array = array("ONTARIO","International Clothiers","Men's/Boy's","Intercity Mall","1000 Fort William Road","Thunder Bay "," ON","P7B 6B9","807-625-5535"); storeouput_city($array);

$array = array("ONTARIO","International Clothiers","Men's/Boy's","Dufferin Mall","900 Dufferin Street ","Toronto"," ON","M6H 4A9","416-538-6122"); storeouput_city($array); 
$array = array("ONTARIO","International Clothiers","","Gerrard Square","1000 Gerrard Street East","Toronto"," ON","M4M 3G6","416-461-8967"); storeouput($array); 

$array = array("ONTARIO","International Clothiers","Men's/Boy's","Devonshire Mall","3100 Howard Avenue","Windsor"," ON","N8X 3Y8","519-969-7425"); storeouput_city($array);
$array = array("ONTARIO","International Clothiers","Men's/Boy's","Tecumseh Mall","7654 Tecumseh Road","Windsor"," ON","N8T 1E9","519-988-1211"); storeouput($array);

$array = array("ONTARIO","International Clothiers","Men's/Boy's","Piazza Del Sole - Woodbridge","200 Winflower Gate ","Woodbridge"," ON","L4L 1X0","905-265-9834"); storeouput_city($array);
?>
<br /><br />
<hr width="100%" size="1" noshade />
...
$array = array("QUEBEC","International Clothiers","Men's","Promanades De L'Outaouais","Unit H3","Gatineau"," QC","J8T 6G3","819-568-7129"); storeouput_city($array);
 
$array = array("QUEBEC","INC COMPAGNIE","Men's","Galeries Joliette","1075 Firestone Blvd","Joliette"," QC","J6E 6X6","450-752-0075"); storeouput_city($array);
 
$array = array("QUEBEC","INC COMPAGNIE","Men's","Carrefour Angrignon","7077 Newman Blvd","Lasalle"," QC","H8N 1X2","514-363-2366"); storeouput_city($array);
  
$array = array("QUEBEC","International Clothiers","Men's","Centre Laval","1600 Le Corbusier Blvd.","Laval"," QC","H7S 1Y9","450-973-1611"); storeouput_city($array);
 
$array = array("QUEBEC","INC COMPAGNIE","Men's","Place Versailles","7275 Rue Sherbrooke Est","Montreal"," QC","H1N 1E9","514-355-5321"); storeouput_city($array);
$array = array("QUEBEC","Petrocelle","Men's/Boy's","Place Versailles","7275 Rue Sherbrooke est","Montreal"," QC","H1N 1E9","514-354-9264"); storeouput($array);
 
$array = array("QUEBEC","INC COMPAGNIE","Men's","Fairview Pointe Claire","6801 Autoroute Transcanadienne","Pointe-Claire"," QC","H9R 1C4","514-694-9099"); storeouput_city($array);

$array = array("QUEBEC","INC COMPAGNIE","Men's","Place Laurier","2700 Laurier Blvd","Quebec City"," QC","G1V 4J9","418-652-9009"); storeouput_city($array); 
$array = array("QUEBEC","INC COMPAGNIE","Men's","Promenades Beauport","3333 Rue de Carrefour","Quebec City"," QC","G1C 5R9","418-661-9202"); storeouput($array);
...
$array = array("QUEBEC","INC COMPAGNIE","Men's","Place Vertu","3131 Cote Vertu","Saint Laurent"," QC","H4R 1Y8","514-333-6624"); storeouput_city($array);
?>
...
<h1>Saskatchewan</h1>
<?php
$array = array("SASKATCHEWAN","International Clothiers","Men's","Gateway North Plaza","1403 Central Avenue","Prince Albert"," SK","S6V 7J4","306-922-5490"); storeouput_city($array);

$array = array("SASKATCHEWAN","International Clothiers","Men's/Women's/Boy's","Golden Mile Shopping Centre","3806 Albert Street","Regina"," SK","S4S 3R2","306-949-4776"); storeouput_city($array);

$array = array("SASKATCHEWAN","International Clothiers","Men's/Women's","Victoria Square","2223 Victoria Avenue East","Regina"," SK","S4N 6E4","306-584-9439"); storeouput_city($array);
?>
